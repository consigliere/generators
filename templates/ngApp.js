...
var imagesSrcPath   = srcPath + 'src/' + name + '/images/',
    imagesDestPath  = destPath + 'src/images/',
    scriptsSrcPath  = srcPath + 'src/' + name + '/scripts/',
    scriptsDestPath = destPath + 'src/scripts/',
    stylesSrcPath   = srcPath + 'src/' + name + '/styles/',
    stylesDestPath  = destPath + 'src/styles/';
...
var
    ngApps = {
        ...
        appsComponent : {
            src     : scriptsSrcPath + '/' + name + '/src/components/app-components/*.txt',
            fileName: 'appComponents.example.js',
            dest    : scriptsDestPath + dataSrc.package_name + '/src/components/app-components'
        },
